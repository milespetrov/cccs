...
const BASE_MAP_URL = './assets/configs/normal';
...
class NormalApi extends DatasetApi {
    ...
    async getDataLayers(configVersion: string): Promise<any[]> {
        const fetchUrl = `${BASE_MAP_URL}/${configVersion}/normal-layer-configs-${this.state.variableId}-${
