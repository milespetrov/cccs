...
const BASE_MAP_URL = './assets/configs/CANGRD';
...
class CanGrdApi extends DatasetApi {
    ...
    async getDataLayers(configVersion: string): Promise<any[]> {
        const fetchUrl = `${BASE_MAP_URL}/${configVersion}/cangrd-layer-configs-${this.state.variableId}-${
