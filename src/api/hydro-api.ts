...
const BASE_MAP_URL = './assets/configs/hydrometric';
...
class HydroApi extends DatasetApi {
    ...
    async getDataLayers(configVersion: string): Promise<any[]> {
        const fetchUrl = `${BASE_MAP_URL}/${configVersion}/hydro-layer-configs-${this.state.variableId}-${
