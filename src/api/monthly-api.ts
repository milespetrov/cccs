...
const BASE_MAP_URL = './assets/configs/CanSIPS';
...
class MonthlyApi extends DatasetApi {
    ...
    async getDataLayers(configVersion: string): Promise<any[]> {
        const fetchUrl = `${BASE_MAP_URL}/${configVersion}/monthly-layer-configs-${this.state.variableId}-${
