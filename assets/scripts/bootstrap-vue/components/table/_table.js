...
export default {
    ...
    render: function render(h) {
        ...
        if ($scoped["top-row"] && t.isStacked !== true) {
            rows.push(
                h("tr", { key: "top-row", class: ["b-table-top-row", t.tbodyTrClass] }, [
        ...
        items.forEach(function (item, rowIndex) {
            ...
            if (rowShowDetails) {
                ...
                var details = h("td", { attrs: tdAttrs }, [
        ...
        if (t.showEmpty && (!items || items.length === 0)) {
            ...
            empty = h("td", { attrs: { colspan: String(fields.length), role: t.isStacked ? "cell" : null } }, [
        ...
        if ($scoped["bottom-row"] && t.isStacked !== true) {
            rows.push(
                h("tr", { key: "bottom-row", class: ["b-table-bottom-row", t.tbodyTrClass] }, [
                ...
                this.fields
                    ...
                    .forEach(function (f) {
                        if (typeof f === "string") {
                            ...
                            (typeof f === "undefined" ? "undefined" : _typeof(f)) === "object" &&
                            f.key &&
                            typeof f.key === "string"
                        ) {
